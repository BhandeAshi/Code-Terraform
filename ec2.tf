output "ec2_instance_private_ip" {
 ...
 resource "aws_instance" "RDS-instance" {
   ...
   user_data = <<-EOF
               ...
               DB_NAME="studentapp"
               TABLE_NAME="students"
               mysql -u $DB_USER -h database-1.c8fpd84fg1en.us-east-1.rds.amazonaws.com -p$DB_PASSWORD <<EOF
